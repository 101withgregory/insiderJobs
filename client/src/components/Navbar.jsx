    ...
    return (
        <div className='shadow py-4'>
            <div className='container px-4 2xl:px-20 mx-auto flex justify-between'>
                <img onClick={()=>goTo('/')} className='cursor-pointer' src={assets.logo} alt='insiderJobs' />
                {
                    user ? <div className='flex items-center gap-3'>
                        ...
                        <button className='text-gray-600 cursor-pointer' onClick={e => setShowRecruiterLogin(true)}>Recruiter Login</button>
